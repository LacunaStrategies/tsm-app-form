        ...
        <>
            <form onSubmit={handleSubmit}>
                ...
                >
                    {
                        activeQuestion === 1 && (
                            <motion.div
                                ...
                                key="q1"
                            >
                                <h2 id="questionTitle" className="font-semibold uppercase text-xl mb-4 max-w-lg mx-auto">What best describes you?</h2>
                                ...
                                <div id="questionContent">
                                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5 md:gap-x-9 md:gap-y-14">
                                        {
                                            questionOneOptions.map((question, i) => (
                                                <button
                                                    key={i}
                                                    className={`bg-sportsBlue text-sportsTan p-3 text-left shadow-black shadow-sm rounded-md ${question.label === values.q1 && 'border-2 border-red-600'}`}
                                                    type="button"
                    ...
                    }
                    {
                        activeQuestion === 2 && (
                            <motion.div
                                ...
                                key="q2"
                            >
                                <h2 id="questionTitle" className="font-semibold uppercase text-xl mb-4 max-w-lg mx-auto">What do you love about Web3 and what would you change?</h2>
                    ...
                    }
                    {
                        activeQuestion === 3 && (
                            <motion.div
                                ...
                                key="q3"
                            >
                                <h2 id="questionTitle" className="font-semibold uppercase text-xl mb-4 max-w-lg mx-auto">What are you working on?</h2>
                                <div id="questionDesc" className="mb-9 max-w-sm mx-auto font-thin text-sm">Tell us about something you&apos; building, doing, your goals, etc.</div>
                                <div id="questionContent">
                                    <textarea
                                        className="border border-sportsGray outline-none rounded-xl p-9 w-full max-w-xl bg-transparent"
                                        rows={8}
                    ...
                    }
                    {
                        activeQuestion === 4 && (
                            <motion.div
                                ...
                                key="q4"
                            >
                                <h2 id="questionTitle" className="font-semibold uppercase text-xl mb-4 max-w-lg mx-auto">Why do you want to be in The Sports Metaverse?</h2>
                                <div id="questionDesc" className="mb-9 max-w-sm mx-auto font-thin text-sm"></div>
                                <div id="questionContent">
                                    <textarea
                                        className="border border-sportsGray outline-none rounded-xl p-9 w-full max-w-xl bg-transparent"
                                        rows={8}
                    ...
                    }
                    {
                        activeQuestion === 5 && (
                            <motion.div
                                ...
                                key="q5"
                            >
                                <h2 id="questionTitle" className="font-semibold uppercase text-xl mb-4 max-w-lg mx-auto">What&apos;s your favorite sport team (1 only please)?</h2>
                                <div id="questionDesc" className="mb-9 max-w-sm mx-auto font-thin text-sm"></div>
                                <div id="questionContent">
                                    <textarea
                                        className="border border-sportsGray outline-none rounded-xl p-9 w-full max-w-xl bg-transparent"
                    ...
                    }
                    {
                        activeQuestion === 6 && (
                            <motion.div
                                ...
                                key="q6"
                            >
                                <h2 id="questionTitle" className="font-semibold uppercase text-xl mb-4 max-w-lg mx-auto">If chosen, who would you recruit to be on your scout team (2 friends)?</h2>
                                <div id="questionDesc" className="mb-9 max-w-sm mx-auto font-thin text-sm"></div>
                                <div id="questionContent">
                                    <textarea
                                        className="border border-sportsGray outline-none rounded-xl p-9 w-full max-w-xl bg-transparent"
                ...
                <div className="flex flex-col w-full max-w-lg mx-auto text-xl font-bold mt-8 sm:flex-row sm:space-between">
                    ...
                    {   // Next Button
                        (activeQuestion > 1 && activeQuestion < 7) &&
                        <button
